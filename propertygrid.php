...
?><!-- FOR MORE PROJECTS visit: Iandez.com -->
<!DOCTYPE html>
<html lang="en">
<head>
<!-- Required meta tags -->
        ...
        <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
            <div class="container">
                <div class="row">
                    ...
                    </div><!-- FOR MORE PROJECTS visit: Iandez.com -->
                    <div class="col-md-6">
                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="price text-primary text-capitalize">$<?php echo $row['13'];?> <span class="text-white"><?php echo $row['12'];?> ksh</span></div>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-widget">
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Payment</h4>
						<form class="d-inline-block w-100" action="amnt.php" method="post">
                            ...
                            <label class="sr-only">Rental Rate</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">Ksh</div>
                                </div>
                                <input type="text" class="form-control" name="Rental" placeholder="Interest Rate">
                            </div>
                            <button type="submit" value="submit" name="amnt" class="btn btn-danger mt-4">Amount Payable</button>
                        </form>
                        </div>
