                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <select class="col-md-8 col-lg-6" name="type">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        </div>It is owned by a group of stakeholders who came up with an idea of making a better home for a better future.</p>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>It is owned by a group of stakeholders who came up with an idea of making a better home for a better future.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
