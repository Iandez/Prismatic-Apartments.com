            ...
            <div class="container">
                <div class="row"> 
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    <li><span class="text-secondary"><?php echo $row['12'];?></span> Square perfeet</li>
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Mode of Payment</h4>
                        <form class="d-inline-block w-100" action="calc.php" method="post">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                ...
                                <input type="text" class="form-control" name="month" placeholder="Period per Year">
                            </div>
                            <label class="sr-only">Rental Rates</label>
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">Ksh</div>
                                </div>
                                <input type="text" class="form-control" name="rental" placeholder="rental Rate">
                            </div>
